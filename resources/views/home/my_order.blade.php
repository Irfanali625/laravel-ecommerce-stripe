                ...
                <div class="row">
                    <div class="col-lg-10 offset-lg-1">
                        ...
                        <div class="cart_container">
                            <div class="cart_title">My Orders<small> ({{ $order->count() }} item in your Order)
                                </small></div>
                                        ...
                                        <li class="cart_item clearfix">
                                            ...
                                            <div
                                                ...
                                                <div class="cart_item_price cart_info_col">
                                                    ...
                                                    <div class="cart_item_text">{{ $item->payment_status }}</div>
                                                </div>
                                                <div class="cart_item_price cart_info_col">
                                                    <div class="cart_item_title">Delivery Status</div>
                                                    <div class="cart_item_text">{{ $item->delivery_status }}</div>
                                                </div>
                                                <div class="cart_item_total cart_info_col">
                                                    <div class="cart_item_title">Action</div>
                                                    <div class="cart_item_text">
                                                        @if ($item->payment_status == 'Cash on Delivery' and $item->delivery_status !== 'Delivered')
                                                            <a href="{{ url('cancel_order', $item->id) }}"
                                                                onclick="return confirm('Are You Want to Cancel this order')"
